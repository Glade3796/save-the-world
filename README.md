...
<h3 align="center">Save The World</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/glade3796/save-the-world"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `glade3796`, `save-the-world`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Save the World`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/glade3796/save-the-world.git
   ```
